...
| ------------------------------- | ------------------------------------------------------------------------------------- | -------------------------------------- | --------- |
| **Authentication**              | Identify users via signed initData (in-app) or QR code login (browser)                | [Login & Registration](en/AUTH.md)     | Shipped   |
| **Token Payments**              | Accept USDK/CNYT payments via order-based or direct transfer flows                    | [Payment Integration](en/PAYMENT.md)   | Shipped   |
| **Escrow / Guaranteed Payment** | Lock funds until a deal completes; C2C + Guarantee contracts with jury dispute (K币担保) | [Escrow](en/ESCROW.md)                 | Shipped   |
| **Subscription Payment**        | Recurring billing where the user confirms every charge — no silent auto-deduction     | [Subscription](en/SUBSCRIPTION.md)     | Design    |
| **Contract Interaction**        | Call any smart contract on the NEXLK chain through the wallet                         | [Contract Interaction](en/CONTRACT.md) | Shipped   |
| **NFT Issuance**                | Issue normal and soulbound (SBT) ERC-721 tokens                                       | [NFT Issuance](en/NFT.md)              | SDK-ready |
| **Community Governance**        | Stake, propose, and vote; Delegate ID as an NFT (Tally-style DAO)                     | [Governance](en/GOVERNANCE.md)         | Design    |
...
* **External browser** — dApp runs in Chrome/Safari with QR code flows for payments and contract calls (QR auth is planned but not yet implemented — see [AUTH.md Section 3.1](en/AUTH.md))
...
Each feature has a corresponding QR flow — see [AUTH.md](en/AUTH.md), [PAYMENT.md](en/PAYMENT.md), and [CONTRACT.md](en/CONTRACT.md) for details.
...
> For complete method signatures and parameters, see [API Reference](en/API.md).
...
| ------------------------------------------- | ------------------------------------------------------------- |
| [API Reference](en/API.md)                  | Types, endpoints, and JS SDK method signatures                |
| [Login & Registration](en/AUTH.md)          | initData, signature verification, QR login, account binding   |
| [Payment Integration](en/PAYMENT.md)        | USDK/CNYT payments — direct transfer and order-based flows    |
| [Escrow / Guaranteed Payment](en/ESCROW.md) | C2C + Guarantee escrow contracts, roles, jury dispute (K币担保)  |
| [Subscription Payment](en/SUBSCRIPTION.md)  | Confirm-before-charge recurring billing (design spec)         |
| [Contract Interaction](en/CONTRACT.md)      | Smart contract calls — EIP-1193, NexLink SDK, and QR flows    |
| [NFT Issuance](en/NFT.md)                   | Normal and soulbound (SBT) ERC-721 issuance and minting       |
| [Community Governance](en/GOVERNANCE.md)    | Staking, proposals, voting, and Delegate ID NFT (design spec) |
