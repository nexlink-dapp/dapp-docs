...
> **任何 DAO 都可以使用。** 这是一套通用的、**Tally 风格的治理框架，而非 NexLink 专用系统**——任何社区都可以在链 `2026777` 上部署自己的治理代币、Governor 与 Delegate-ID NFT，并获得同样的工具。NexLink 自身的治理只是其中一个实例。
...
> **一人一票。** 灵魂绑定的参议院席位在投票者的**主身份**处计票——即对应物理个人、每人仅一个的身份——因此一个用户的多个人格无法灌票。见 [身份系统](IDENTITY.md)。
